...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('🤴вσт σωηєя🤴', url=f'https://t.me/MrMaDYt'),
            InlineKeyboardButton('🍁вσт gяσυρ🍁', url='https://t.me/netflixindiasupport')    
            ],[
            InlineKeyboardButton('🍿נσιη συя мαιη ¢нαηηєℓ🍿', url='http://t.me/NETFLIXINDIA2022')
        ]]
    ...
    await client.send_cached_media(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🍁 נσιη gяσυρ 🍁", url="https://t.me/netflixindiasupport"),
