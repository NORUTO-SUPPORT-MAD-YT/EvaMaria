...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('🤴вσт σωηєя🤴', url=f'https://t.me/OGGYMAMAN'),
            InlineKeyboardButton('🍁вσт gяσυρ🍁', url='https://t.me/mallumovie11')    
            ],[
            InlineKeyboardButton('🍿נσιη συя мαιη ¢нαηηєℓ🍿', url='https://t.me/MFCMCHANNEL')
        ]]
    ...
    await client.send_cached_media(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🍁 נσιη gяσυρ 🍁", url="https://t.me/mallumovie11"),
