...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('🤴вσт 𝙾𝚆𝙽𝙴𝚁🤴', url=f'https://t.me/IAM_YOUR_NARUTO'),
    ...
    if len(message.command) ==2 and message.command[1] in ["subscribe", "error", "okay"]:
        buttons = [[
            InlineKeyboardButton('🤴вσт σωηєя🤴', url=f'https://t.me/IAM_YOUR_NARUTO'),
            InlineKeyboardButton('🍁вσт gяσυρ🍁', url='https://t.me/new_movies_group_2021')    
            ],[
            InlineKeyboardButton('🍿נσιη συя мαιη ¢нαηηєℓ🍿', url='https://t.me/new_all_movies_club')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await message.reply_photo(
            photo=random.choice(PICS),
    ...
    await client.send_cached_media(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🍁 נσιη gяσυρ 🍁", url="https://t.me/new_movies_group_2021"),
